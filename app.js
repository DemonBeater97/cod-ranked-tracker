...
const I18N = {
  de: {
    ...
    'help.h11': 'SR-Verlauf', 'help.p11': 'Fahr mit der Maus über einen Punkt im SR-Verlauf-Chart (oder tipp am Handy drauf), um Details zu diesem Match zu sehen. Grün = SR gewonnen, Rot = SR verloren.',
  ...
  en: {
    ...
    'help.h11': 'SR history', 'help.p11': 'Hover over a point in the SR history chart (or tap it on mobile) to see details for that match. Green = SR gained, red = SR lost.',
